                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#tambahUserModal">Tambah Dokter</button>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="role" class="form-control" required id="role" readonly>
                                        <option value="dokter" select>DOKTER</option>
                                    </select>
                                </div>
                            </div>
